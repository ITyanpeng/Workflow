...
public class CustomerControllerClassNameHandlerMapping extends
	...
	/**
	 * Set the base package to be used for generating path mappings, including
	 * all subpackages underneath this packages as path elements.
	 * <p>
	 * Default is <code>null</code>, using the short class name for the
	 * generated path, with the controller's package not represented in the
	 * path. Specify a base package like "com.mycompany.myapp" to include
	 * subpackages within that base package as path elements, e.g. generating
	 * the path "/mymodule/buyform" for the class name
	 * "com.mycompany.myapp.mymodule.BuyForm". Subpackage hierarchies are
	 * represented as individual path elements, e.g.
	 * "/mymodule/mysubmodule/buyform" for the class name
	 ...
	 * <p>
	 * Subclasses may choose to customize the paths that are generated by
	...
	// boolean flag = (Controller.class.isAssignableFrom(beanClass) ||
	// ThrowawayController.class
	// .isAssignableFrom(beanClass));
	// if (org.codehaus.xfire.spring.remoting.XFireExporter.class
	// .isAssignableFrom(beanClass)) {
	// flag = false;
	// }
	// return flag;
	 ...
	 * @param beanClass
	 *            the controller bean class to generate a mapping for
	 * @return the path prefix, potentially including subpackage names as path
	 *         elements
	 */
